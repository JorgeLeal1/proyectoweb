...
public class CuentaController {
	...
	public CuentaController(CuentaServiceInterface cuentaServiceInterface,
	...
	public boolean registrar(@RequestParam String Run, @RequestParam String Nombre1, @RequestParam String Nombre2,
		...
		if (clienteServiceInterface.insertarCliente(cliente) && cuentaServiceInterface.insertarCuenta(cuenta)
	...
	public String transferir(Model model) {
		...
		model.addAttribute("cuentaTercero",
				cuentaTerceroServiceInterface.obtenerTodoCuentaTercero(cuentaModel.getNroCuenta()));
	...
	public String buscarCuentaTercero(@RequestParam String Run, @RequestParam Double Saldo, Model model) {
		Date current = new Date();
		...
		// Ingresamos el movimiento a la tabla transaccion
		UsuarioModel IdusuarioEnv = usuarioServiceInterface.consultarUsuarioPorRun(run_usuario);
		UsuarioModel IdusuarioRec = usuarioServiceInterface.consultarUsuarioPorRun(Run);
